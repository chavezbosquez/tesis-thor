...
$auth_users = array(
    // OCB
    'chavez' => '$2y$10$iwyixE.H/VKfZLoC5PwAbecyDhgGiVSIn1wX.mxqnUnFsOIy7BZs.',
    // Contraseña del administrador de THOR
    'admin' => '$2y$10$xUocwinALpsr8466myGBiePMV8gQXPE3UObnVz7YVfHPJaxFPd.Hi'
);
...
$default_timezone = 'America/Mexico_City'; // 'Etc/UTC'; // UTC

// Root path for file manager
// use absolute path of directory i.e: '/var/www/folder' or $_SERVER['DOCUMENT_ROOT'].'/folder'
$root_path = $_SERVER['DOCUMENT_ROOT'].'/thor/docs';
...
$GLOBALS['exclude_items'] = array('.git','.vscode');
