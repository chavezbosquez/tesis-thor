...
function dir_list_form() {
    ...
    // OCB: Quitar opciones de administración de directorios
    /*$out .= "
    <table class=\"table\">
        ...
        <form action=\"".$fm_path_info["basename"]."\" method=\"post\" onsubmit=\"return test_action();\">
            <div class=\"float-left\"><label>ADIOS</label>
    ...
    // OCB: Ruta y botón para subir de directorio
    /*$out .= "
    ...
    if (!$io_error) {
        if($entry_count){
            // OCB: Quitar botones de eliminar archivos
            /*$out .= "
            ...
            // OCB: Eliminar botones de abajo (misma lista que arriba)
            /*$out .= "
                <tr>
                <td bgcolor=\"#DDDDDD\" colspan=50><nobr>
...
function et($tag){
    ...
    $et['es']['SelAll'] = 'Seleccionar todo';
    $et['es']['SelNone'] = 'Seleccionar ninguno';
    $et['es']['SelInverse'] = 'Invertir selección';
    ...
    $et['es']['Close'] = 'Cerrar'; // OCB: faltaba esta entrada
